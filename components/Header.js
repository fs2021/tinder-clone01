...
// temporary, hard set my wallet
const currentAccount = "0xa6189d8259962fab5dAf20Af35bbF54B731AF820"
        ...
        <div className={style.main}>
            ...
            <div className={style.leftMenu}>
                <div className={style.menuItem}>
                    <a href="https://testnets.opensea.io/account">NFT</a></div>
            ...
            <div className={style.rightMenu}>
                <div>English</div>
                {/* //when is logged in, button is swapped for current account */}
